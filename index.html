...
<div id="notes">
  <div>告知：</div>
  <div class="note"><span class="number">①</span><span style="font-weight: bold; border-bottom: 2px solid;">同样的产品，在不同经销商处的销售价格可能不一致。</span>由于当初我们定价并未考虑到给经销商预留合理的利润空间，出于他们自身的运营成本，售价可能会比我们的略高一些。</div>
